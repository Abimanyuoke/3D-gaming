...
export default function Footer() {
    return (
        <footer className="flex items-center justify-between lg:mt-[15%] mt-[25%] py-8 lg:px-32 md:px-16 px-8 border-t-[0.3px] border-[#babaff]">
            <img src="src/assets/public/images/illu-text.png" alt="Illu-Text" className="h-10" />
            <img src="src/assets/public/images/illu-logo.png" alt="Illu-Logo" className="h-16 md:inline hidden" />
