export default function Hero() {
    return (
        <main className="relative w-full h-screen overflow-hidden flex justify-center mb-[10%]">
            <video src="src/assets/public/videos/hero.mp4" autoPlay loop muted playsInline className="w-full h-[95%] object-cover absolute top-0 first-letter:left-0 -z-10"></video>
            <div className="absolute bottom-[15%] flex flex-col items-center gap-5">
                <img src="src/assets/public/images/illu-text.png" alt="illu-text" className="md:w-[30rem] w-[20rem]" />
                ...
                <div className="flex items-center gap-5 text-3xl font-extrabold text-gray-200 ">
                    <img src="src/assets/public/images/illu-logo.png" alt="illu-logo" className="md:h-16 h-12" /> ZERO
                </div>
